  ...
  return (
    <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
      <h2 className="text-center text-xl md:text-3xl font-semibold mb-3 md:mb-10">
        Explore Fascinating Colleges
      </h2>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
        {collegesData.map((college, index) => (
          <div
            key={index}
            className="relative mx-auto w-full max-w-sm pt-6 shadow-lg px-2 pb-2"
          >
            <div
              key={index}
              className="relative mx-auto w-full max-w-sm pt-6 shadow-lg px-2 pb-2"
              ...
              <div className="rounded-lg">
                <div className="relative flex h-60 justify-center overflow-hidden rounded-lg">
                  <div className="w-full transform transition-transform duration-500 ease-in-out hover:scale-110">
                    <img src={college.college_image} className="h-[300px]" />
                  </div>
                </div>
                <div className="">
                  ...
                  <div className="mt-2 grid grid-cols-2 grid-rows-2 gap-4 border-b border-t border-gray-200 pb-3 pt-3">
                    ...
                    <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                      ...
                      <span className="mt-0 text-gray-500">
                        {" "}
                    ...
                    <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                      ...
                      <span className="mt-0 text-gray-500">
                        Research History {college.research_history.length}
                      </span>
                    </p>
                    <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                      <svg
                      ...
                      <span className="mt-0 text-gray-500">
                        Sports Items {college.sports_categories.length}{" "}
                      </span>
                    </p>
                  </div>
                  <Link to={`/collagedetails/${college._id}`}>
