    ...
    <div className="mx-auto w-full max-w-sm pt-6">
      <div className=" shadow-md border">
        <div className="h-60 overflow-hidden">
          <div className="w-full transform transition-transform duration-700 ease-in-out hover:scale-125">
            <img className="" src={college_image} alt="collage image" />
          </div>
        </div>
        <div className="px-4 py-6">
          <h2 className="line-clamp-1 text-lg font-medium text-gray-800 md:text-xl mb-2">
            {college_name}
          </h2>
          <div className="mt-2 grid grid-cols-2 grid-rows-2 gap-4 border-t border-gray-200 pb-3 pt-3">
            <p className="flex items-center text-gray-800 xl:flex-row xl:items-center text-sm md:text-base">
              <svg
              ...
              <span className="xl:mt-0">{admission_dates} </span>
            </p>
            <p className="flex items-center text-gray-800 xl:flex-row xl:items-center text-sm md:text-base">
              <svg
                className="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4"
              ...
              <span className="mt-0">Available events: {events.length}</span>
            </p>
            <p className="flex items-center text-gray-800 xl:flex-row xl:items-center text-sm md:text-base">
              <svg
                className="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4"
              ...
              <span className="mt-0">
                Total Research: {research_history.length}
              </span>
            </p>
            <p className="flex items-center text-gray-800 xl:flex-row xl:items-center text-sm md:text-base">
              <svg
...
export default UnearthingCollegeInfo;
